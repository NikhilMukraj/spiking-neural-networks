...
The D1 stimulation demonstrates that the AMPA, NMDA, and GABAa conductances, along with distortion, have a statistically significant effect on Bayesian accuracy. 
...
The D2 simulation shows that AMPA, NMDA, and GABAa conductances, along with distortion, also have a clear statistically significant effect on Bayesian accuracy.
While D2 works in an inhibitory capacity it appears as though the effects of varying AMPA, NMDA, and GABAa conductances are similar to the D1 simulation.
